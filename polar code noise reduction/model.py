...
import numpy as np
#citation: https://blog.csdn.net/qq_43432826/article/details/122062290
...
class Encoder(nn.Module):
    def __init__(self,src_vocab_size,d_model,n_layers,tgt_vocab_size,d_k,n_heads,d_v,d_ff):
        ...
        self.projection =nn.Sequential(
            nn.Linear(d_model, d_ff, bias=False),
            nn.ReLU(),
            nn.Linear(d_ff, 64, bias=False),
            nn.ReLU(),
            nn.Linear(64, tgt_vocab_size, bias=False)
        )
